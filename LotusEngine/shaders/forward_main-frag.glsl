...
void main()
{
	vec2 texCoord = calcParallaxTexCoords(material_dispMap, fs_in.tbn_matrix, normalize(camera_pos - fs_in.worldPos), fs_in.texCoord, material_dispMapScale, material_dispMapBias);
