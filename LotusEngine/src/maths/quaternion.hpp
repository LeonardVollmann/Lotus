...
template <typename T>
inline quat<T> operator*(const quat<T> &l, T r)
{
	return mul(l, r);
}
...
template <typename T>
inline quat<T> operator*(const quat<T> &l, const vec<T, 3> &r)
{
	return mul(l, r);
}

template <typename T>
inline void operator*=(quat<T> &l, T r)
{
	l = l * r;
}

template <typename T>
inline void operator*=(quat<T> &l, const quat<T> &r)
{
	l = l * r;
}

template <typename T>
inline void operator*=(quat<T> &l, const vec<T, 3> &r)
{
	l = l * r;
}
