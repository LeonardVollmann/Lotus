...
void TextureResource::initTextures(
    unsigned char **data, GLfloat *filters, GLenum *internalFormats, GLenum *formats, bool *clamp)
{
                 ...
                 GLenum *attachments)
{
	...
	{
		data[i] = stbi_load((TEXTURE_IMAGE_FILE_DIRECTORY + fileNames[i]).c_str(),
		                    &width,
		                    &height,
		                    &numComponents,
		                    4);
	...
	m_textureResource = ResourceManager::create<TextureResource>(name,
	                                                             true,
	                                                             textureTarget,
	                                                             width,
	                                                             height,
