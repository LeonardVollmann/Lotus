                                           ...
                                           GLuint *locations)
{
	...
	locations[1] =
	    glGetUniformLocation(shader->getShaderProgram(), (name + ".base.intensity").c_str());
...
DirectionalLight::DirectionalLight(const maths::vec3f &color,
                                   float intensity,
                                     ...
                                     GLuint *locations)
{
	...
	locations[1] =
	    glGetUniformLocation(shader->getShaderProgram(), (name + ".base.intensity").c_str());
	locations[2] =
	    glGetUniformLocation(shader->getShaderProgram(), (name + ".atten.constant").c_str());
	locations[3] =
	    glGetUniformLocation(shader->getShaderProgram(), (name + ".atten.linear").c_str());
	locations[4] =
	    glGetUniformLocation(shader->getShaderProgram(), (name + ".atten.exponent").c_str());
...
PointLight::PointLight(const maths::vec3f &color,
                       float intensity,
...
{
	float maxColorValue = pointLight.getColor().x > pointLight.getColor().y
	                          ? pointLight.getColor().x
	                          : pointLight.getColor().y;
	if (pointLight.getColor().z > maxColorValue)
		maxColorValue = pointLight.getColor().z;

	float a = pointLight.getAttenuation().getExponent();
	float b = pointLight.getAttenuation().getLinear();
	float c = pointLight.getAttenuation().getConstant() -
	          COLOR_DEPTH * pointLight.getIntensity() * maxColorValue;
...
{
	locations[0] =
	    glGetUniformLocation(shader->getShaderProgram(), (name + ".pointLight.base.color").c_str());
	locations[1] = glGetUniformLocation(shader->getShaderProgram(),
	                                    (name + ".pointLight.base.intensity").c_str());
	locations[2] = glGetUniformLocation(shader->getShaderProgram(),
	                                    (name + ".pointLight.atten.constant").c_str());
	locations[3] = glGetUniformLocation(shader->getShaderProgram(),
	                                    (name + ".pointLight.atten.linear").c_str());
	locations[4] = glGetUniformLocation(shader->getShaderProgram(),
	                                    (name + ".pointLight.atten.exponent").c_str());
	locations[5] =
	    glGetUniformLocation(shader->getShaderProgram(), (name + ".pointLight.pos").c_str());
	locations[6] =
	    glGetUniformLocation(shader->getShaderProgram(), (name + ".pointLight.range").c_str());
...
SpotLight::SpotLight(const maths::vec3f &color,
                     float intensity,
                     const Attenuation &atten,
                     const maths::vec3f &pos,
                     const maths::vec3f &direction,
