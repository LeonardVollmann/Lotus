...
VarUniform<VAR_T>::VarUniform(const ShaderResource *shader,
                              const char *name,
                              unsigned char **owner,
                              size_t varOffset)
...
template <typename VAR_T>
MaterialUniform<VAR_T>::MaterialUniform(const ShaderResource *shader,
...
template <typename VAR_T>
FunctionUniform<VAR_T>::FunctionUniform(const ShaderResource *shader,
                                        const char *name,
...
template <
    ...
    void GET_LOCATIONS(const ShaderResource *shader, const std::string &name, GLuint *locations)>
StructUniform<VAR_T, NUM_MEMBERS, GET_LOCATIONS>::StructUniform(const ShaderResource *shader,
